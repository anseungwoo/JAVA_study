...
public class Ex {
	...
	public static void main(String[] args) {
		...
		// while문 반복 종료 후에도 변수 i 값에 접근이 가능함
		System.out.println("while문 종료 후 i값 = " + i );
		
		System.out.println("-------------------------------");
		
		//제어변수 i가 1 ~ 10까지 1씩 증가하면서 i값을 출력
		...
		// 제어변수 i가 1 ~ 10까지 2씩 증가하면서 i값 출력(짝수 출력)
		// => 1 3 5 7 9
		i = 2; //초기식
		...
		System.out.println(); // 잘 바꿈 역할
		System.out.println("while문 종료 후의 i값 = " + i);
