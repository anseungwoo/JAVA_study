...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * - Wrapper 클래스타입 객체 -> 기본데이터타입으로 자동으로 변환하는 기능
...
//		Integer n2 = new Integer(20); // 정수 20을 갖는 인스턴스를 생성하고
		...
		// Wrapper 클래스에는 toString() 메서드가 오버라이딩이 되어 있어
...
//		num2 = n2.intValue(); // Integer 객체 -> int 타입으로 변환하는 메서드
		...
		// => 기본데이터타입 과 Wrapper 클래스타입간의 연산 수행할 경우
		//    Wrapper 클래스 타입 객체를 오토 언박싱 후 연산을 수행
