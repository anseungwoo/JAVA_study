...
public class Ex {
	...
	public static void main(String[] args) {
		/*
		 * 인터페이스(Interface)
		 * - 클래스가 아니므로 선언 시 class 키워드를 사용하지 않음
		 ...
		 *   => implements 키워드 뒤에 복수개의 인터페이스 지정이 가능
		 * - 인터페이스끼리 상속받을 경우 implements가 아닌 extends 로 상속
...
// 인터페이스를 상속받아 구현하는 서브클래스(구현체클래스) MySubClass 정의
