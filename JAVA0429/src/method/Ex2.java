...
//		sister_2(); // sister_2() 메서드 호출
		// 리턴값이 있는 메서드를 호출한 후 리턴받는 데이터는 변수에 저장하거나
		// 출력문 등의 다른 곳에 직접 사용할 수 있다!
		String result = sister_2(); // 메서드 호출 후 리턴값(문자열 "물")을 result 변수에 저장
		// => 위의 코드와 동일한 역할을 수행하는 코드 : String result = "물";
...
//		return "물";
		...
		String str = "물";
		return str; // 리턴값("물")을 가지고 원래 위치(호출한 곳)로 되돌아감
	}
