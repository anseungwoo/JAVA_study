...
public class Ex {
	...
	public static void main(String[] args) {
		...
		switch(num) {
			...
			// num이 2일 때 case 2 의 문장을 실행하고 break 문이 없기 때문에
			// 아래쪽 case 3 의 문장도 모두 실행한다!
		...
		switch(num) {
			...
			case 2 :
				...
				break;
				// num 이 2 일 때 case 2 의 출력문 실행 후 break 문을 만나므로
