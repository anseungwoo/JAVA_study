...
//		AbstractClass ac = new AbstractClass(); // 컴파일 에러!
...
class SubClass extends AbstractClass {
	// 추상클래스를 상속받은 서클래스는 반드시 추상메서드 오버라이딩 필수!!
 ...
 * - 추상클래스 : Flyer
 * - 추상메서드 : takeOff(), fly(), land()
 */

abstract class Flyer {
	// 모든 날아다니는 것들에 대한 이륙, 비행, 착률 메서드 정의
