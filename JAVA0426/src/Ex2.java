...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * 8. 배열의 크기는 배열명.length 속성을 통해서 알아낼 수 있음.
		 * 
		 * < 배열 선언 기본 문법 >
		 * 데이터타입[] 변수명;
...
//		score = 90; // 오류발생! Type mismatch: cannot convert from int to int[]
		// => 배열 이름으로 사용되는 변수에는 데이터 저장 불가능!
		
		// 2. 배열 생성 : 배열명 = new 데이터타입[배열크기];
//		score = new int[5];
		// 연속적인 int형 배열 공간 5개를 생성함 (Heap 메모리 영역에 생김)
...
//		System.out.println(score[5]); // 실행 시 오류 발생!!
		...
		// at Ex2.main(Ex2.java:89)
		// => ArrayIndexOutOfBoundsException: 5 => 5번 인덱스가 범위를 벗어남!
		// => at Ex2.main(Ex2.java:89) => Ex2.java 클래스의 89번 라인이 오류
...
//		System.out.println(score[4]); // score 배열의 4번 인덱스 데이터 값 출력
		...
		// => 배열의 모든 인덱스에 접근 시 조건식에 배열 크기 직접 지정하는 경우
		//    배열 크기가 변경되면 조건식 코드도 변경되어야 함!
		
		// 배열명.length 속성을 사용하여 배열의 크기(길이)를 알아낼 수 있다!!
		System.out.println("배열 score의 크기 : " + score.length);
		// => 배열의 크기값을 반복문의 조건식으로 활용하면
...
//			System.out.println(score[i]);
		...
		int arr3, arr4[]; // arr3는 int, arr4는 int[] 타입 변수로 선언됨.
