...
//		arr2 = {1, 2, 3, 4, 5}; // 오류발생! 별도로 초기화 시 사용 불가능!
		...
		// String 타입 문자열 데이터 3개("Java", "JSP", "Server")를 저장하는
		// 배열 strArr 을 생성하고 리터럴로 즉시 초기화까지 수행 후 출력
		String[] strArr = {"Java", "JSP", "Server"};
		...
		// 불필요한 메모리 공간이 되어 Garbage Collector에 의해 정리 대상이 됨
		// => 즉, 더 이상 필요없는 메모리 공간은 자동으로 정리됨
		
		b = c; // c의 주소값을 b에 저장
		// 기존에 b가 참조하던 4, 5, 6 저장공간을 버리고
		// c가 가리키는 7, 8, 9 저장 공간의 주소값을 전달받아 참조함
		// 이 때, 기존 4, 5, 6 저장 공간은 여전히 a에 의해서 참조되고 있으므로
