...
public class Test {
	...
	public static void main(String[] args) {
		 ...
		 * - 출력 형식 : "Address:" 부분을 제외한 나머지 주만 추출하여 출력
		 *   ex) "부산광역시 부산진구 동천로109 삼한골든게이트" 출력
		 */
