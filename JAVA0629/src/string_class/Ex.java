...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *      메모리 공간 낭비가 줄어들게 됨
		 *   => new 연산자를 사용 시 문자열 중복 여부와 무관하게 문자열 객체 생성
		 ...
		 *      StringBuilder 또는 Stringbuffer 클래스 활용해야 함     
		 */
		
		String s1 = "Java Programming";
		String s2 = "		아이티윌		부산 교육센터		";
		String s3 = "자바/JSP/Spring";
		...
		// concat() : 문자열 결합(연결(결합) 연산자보다 연산 속도가 빠름)
...
//		System.out.println(s1 + "!");
		...
		// => 앞에서부터 문자열 "Program" 을 탐색하여 시작인덱스 5 리턴
		...
		System.out.println("s1.replce(Java, Spring) : " + s1.replace("Java", "Spring"));
...
//		String s3 = "자바/JSP/Spring";
		...
		// => 문자열을 "/" 기호를 기준으로 분리하여 String[] 배열 타입으로 리턴
		// => "자바", "JSP", "Spring" 형태로 분리되어 배열에 저장됨
