...
public class Ex5 {
	...
	public static void main(String[] args) {
		 ...
		 *   둘 다 false일 경우만 결과값이 false
		 * - F OR F = F, F OR T = T, T OR F = T, T OR T = T
		 * - 또는, ~이거나 등의 접속사에 해당하는 의미로 사용됨
		 *   => 주로 A 조건 또는 B 조건 중 하나라도 만족하는 조건을 판별하는데 사용
		 ...
		 *   서로 같을 경우 결과값이 false
		 * - F XOR F = F, F XOR T = T, T XOR F = T, T OR T = F
		 *      
		 */
		...
		// 관계연산자와 결합하여 대소 관계에 대한 논리적인 판별 확인 가능
		int num = 1;
