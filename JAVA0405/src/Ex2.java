...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *   산술 연산 의 덧셈이 아닌 단순 문자열 결합(연결)으로 사용됨.
		...
		int a = 10, b = 20;
		System.out.println(a + b); // 일반 산술연산(덧셈기능)
		...
		System.out.println(10 + "20" + 30); // "1020" + 30 => "102030" 문자열
		System.out.println("10" + 20 + 30); // "1020" + 30 => "102030" 문자열
		
		System.out.println(10 + 20 + "30"); // 10+20 => 30 + "30" = "3030" 문자열
...
//		int jumin = 9010101234567; // 오류발생! int 타입으로 표현 불가능함(범위 초과)
