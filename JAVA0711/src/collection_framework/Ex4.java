...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 * - 키는 중복 불가, 값은 중복 가능
		 *   => 키는 Set 타입으로 관리됨
		 * - 대표적인 구현 클래스 : HashMap, Properties 등
		...
		// => map 객체의 모든 엔트리 : {1=자바, 2=JSP, 3=스프링}
...
//		for(Map.Entry<String,String> entry : map) {}
		...
		// 전화전호부의 경우 전화번호가 키로, 이름이 값으로 사용됨
		...
		System.out.println("010-1234-5678 전화번호 존재? " + map2.containsKey("010-1234-5678"));
