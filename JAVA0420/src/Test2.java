...
public class Test2 {
	...
	public static void main(String[] args) {
		// 바깥쪽 for문 i값이 1 ~ 10까지 반복할 동안 (i는 1씩 증가)
		 ...
		 *    이 때, 각 단마다 i 값이 1 ~ 9까지 1씩 증가(안쪽 for문) 
		 *  
		 */
...
//		}
		 ...
		 * 
		 * 주사위 눈 : 1 ~ 6
		 * 주사위(dice1, dice2) 변수 값을 1 ~ 6까지 1씩 증가하면서 반복하면서
