...
class MyDate {
	...
	public MyDate() {
		...
		this(1900,1,1); // 다른 실행코드보다 무조건 먼저 실행되어야 함!
...
//		day = 1;
	...
	// 연도(year), 월(month)를 전달받고 나머지는 1일로 초기화하는 생성자 정의
	public MyDate(int year, int month) {
		// MyDate(int,int,int) 생성자를 호출하여
		// 전달받은 연도(year), 월(month)과 1일 값을 전달하여 초기화
		this(year,month,1);
