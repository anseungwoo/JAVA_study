...
public class Ex2 {
	public static void main(String[] args) {
		 ...
		 *    => 해당 주석 표시 뒤의 한 문장을 실행 대상에 제외시킴
		 *    => 단축키 : 주석 처리할 문장의 라인 아무 위치에서
		 *                1) Ctrl + Shift + C
		 *                2) Ctrl + /
		 *       해제 단축키 : 주석 설정 단축키와 동일
		 *    => 범위 주석 대신 사용 가능하며
		 *       특정 범위의 문장들을 블록 지정한 뒤 주석 처리 시 각각 주석 처리
		 ...
		 *       주로 긴 문장의 설명을 작성하거나, 여러 줄에 걸친 코드를 주석
		 *       처리하는 용도로 사용
		 *    => 단축키 : Ctrl + Shift + /
		 *       해제 단축키 : Ctrl + Shift + \
		 *       ※ 범위 주석 단축키는 잘 사용하지 않는다! 
		 *       
