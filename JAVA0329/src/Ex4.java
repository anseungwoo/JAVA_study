...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 * 해당 변수에 저장된 값을 사용할 수 있음!
		 * => System.out.println(a); // 변수 a에 저장된 값을 사용(출력)
		 */
		...
		a = 10; // int형 변수 a에 정수형 데이터(리터럴) 10 저장(대입) = 초기화
		// => 주의! 변수 선언 없이 초기화 또는 접근 시 오류 발생!
		// 오류 : a cannot be resolved to a variable
		
		// 변수에 접근하여 값을 출력하기(반드시 초기화 후에 사용 가능)
		// => 초기화를 수행하지 않은 채로는 변수 값에 접근 불가능
		//    (The local variable a may not have been initialized)
		System.out.println(a);
		
		// 변수에 새로운 값(데이터)을 저장하면, 기존의 값(데이터)은 제거됨
		a = 99; // 기존에 저장된 정수 10을 버리고 새로운 정수 99로 교체
		System.out.println(a); // 교체된 정수 99가 출력됨
