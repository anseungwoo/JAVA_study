...
public class Ex4 {
	...
	public static void main(String[] args) {
		/*
		 * 2. if ~ else 문
		 * - 조건식 판별 결과가 true일 때와 false 일 때 서로 다른 블록을 실행
		 * - 삼항연산자와 유사한 형태로 수행되나 삼항연산자보다 더 유연함.
		...
		// 정수 num2 에 대해 홀수, 짝수(0 포함) 판별
		int num2 = 9;
		
		// 홀수 : 정수 num2를 2로 나눈 나머지가 1일 경우(1과 같은 경우)
		// 짝수 : 정수 num2를 2로 나눈 나머지가 0일 경우(1과 같은 경우)
		
		// if문을 사용하여 홀수일 경우 "num2은 홀수!" 출력하고
		// 아니면(짝수일 경우) "num2은 짝수!" 출력
		if(num2 % 2 == 1) { // num2 % 2 > 0 과 동일한 조건식
